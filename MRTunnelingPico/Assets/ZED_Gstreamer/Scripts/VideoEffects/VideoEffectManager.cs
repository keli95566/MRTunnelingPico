...
public class VideoEffectManager : MonoBehaviour
{
 ...
 //   public Material RightEye;
	...
	//public Slider PixelWidthSlider;
 ...
 //   }
	...
	//#region HSVC
	//public void OnBrightnessValueChange() 
	//{
	//	updateHSVCValue(LeftEye);
	//	updateHSVCValue(RightEye);
	//}

	//public void OnHueValueChange()
 //   {
	//	updateHSVCValue(LeftEye);
	//	updateHSVCValue(RightEye);
	//}

	//public void OnContrastValueChange()
 //   {
	//	updateHSVCValue(LeftEye);
	//	updateHSVCValue(RightEye);
	...
	//public void OnSaturationValueChange()
 //   {
	//	updateHSVCValue(LeftEye);
	//	updateHSVCValue(RightEye);
	//}

	//public void OnPixelWidthChange()
 //   {
	//	updateHSVCValue(LeftEye);
	//	updateHSVCValue(RightEye);
	//}
	...
	//	m_HueSatValCont.x = HueSlider.value;//EditorGUILayout.FloatField("Hue", m_HueSatValCont.x);
	//	m_HueSatValCont.y = SaturationSlider.value;//EditorGUILayout.FloatField("Saturation", m_HueSatValCont.y);
	//	m_HueSatValCont.z = BrightnessSlider.value;//EditorGUILayout.FloatField("Value (Brightness)", m_HueSatValCont.z);
	//	m_HueSatValCont.w = ContrastSlider.value;//EditorGUILayout.FloatField("Contrast", m_HueSatValCont.w);
 ...
 //   {
	...
	//	m_HueSatValCont.x = 1; // HueSlider.value;//EditorGUILayout.FloatField("Hue", m_HueSatValCont.x);
